<?php
	...
	class MY_Email extends CI_Email {
		...
		private $msgFooter = "If you're not expecting any files from ARCC, kindly ignore this email. <br />Please do not reply to this mail as it is automated and cannot be responded to. This email was sent by the Management Group of Al Rushaid Construction Company, Limited.";
		private $msgFooter2 = "Please do not reply to this mail as it is automated and cannot be responded to. This email was sent by the Management Group of Al Rushaid Construction Company, Limited.";
		private $body = "";		
