...
class CI_Email {
	...
	var	$smtp_host		= "mail.arcc-eei.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "system@arcc-eei.com";		// SMTP Username
	var	$smtp_pass		= "";		// SMTP Password
	var	$smtp_port		= 25;		// SMTP Port
	var	$smtp_timeout	= 15;		// SMTP Timeout in seconds
