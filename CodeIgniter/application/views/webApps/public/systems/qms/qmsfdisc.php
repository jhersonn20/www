		...
		<div class="wrap-form demo-section apply8" style="width: 37.1%;float:right;height: auto;display: block;">
			<fieldset>
				...
				<ul class="formLeft_qms" style="width: 100%;">
					<li>
						<label class="title" for="txt1" style="width: 130px;">Discipline Type:</label><input type="text" required name="txt1" id="txt1" class="k-textbox" style="width: 61%;" />
					</li>
					<li>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: crudService + "directCall/rdisc",
                    contentType: "application/json",
                    type: "GET"
                },
                create: {
                    url: crudService + "manage/rdisc",
                    type: "POST",
			    ...
			    parameterMap: function(data, type) {
			      if (type == "read") {
				    ...
				    fieldSort = ($(data.sort).length ? data.sort[0].field : "desc_code");
				    query = filterFArr;
