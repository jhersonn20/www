	...
	$(document).ready(function(){
        ...
        var grid = $("#uploadBrowse").kendoGrid({
            ...
            columns: [
	            ...
	            {field: "deliv_to_paint",width: 92,title: "Deliv. To Paint"},
	            {field: "paint_date",width: 92,title: "Paint Date"},              
				{field: "qc_releasePaint",width: 114,title: "QC. Release Paint"},       
				{field: "deliv_at_site",title: "Deliv. @ Site"},
			...
			click: function(){
				switch(this.id){
					...
					default:
						...
						$.post(crudService + "directCall/psGlobalMto",{rows: $("#objStr").val()},
							function(data){
