		    			...
		    			case "printButt":
		    				if (confirm("Do you really want to print this item?")){	    					
								...
								$("#window").data("kendoWindow").refresh({
								    url: "http://" + $(location).attr('hostname') + ":8080/JavaBridge/executeReport.php?xmlFile=qms/Material Per Area Register" + "&carea=" + areaNo.value() + "&ioption=" + $('input[name=option]:checked').index('input[name=option]'),
