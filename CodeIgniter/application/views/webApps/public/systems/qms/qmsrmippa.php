...
<div id="main-wrapper">
	<div class="wrap-button demo-section" style="width: 39.5%;min-height: 270px;position: fixed;top: 120px;left: 400px;">
		...
		<div><br /></div>
		<div>
		<label class="title" for="txt2" style="width: 0px;">Date:</label>
		</div>
		<div><br /></div>
		<div>
		    		...
		    		switch(this.id){
		    			case "printButt":
							...
							$("#window").data("kendoWindow").refresh({
							    url: "http://" + $(location).attr('hostname') + ":8080/JavaBridge/executeReport.php?xmlFile=qms/PIPE SUPPORT SUMMARY PER PRIORITY AREA LOCATION" + "&asofdt=" + kendo.toString(start.value(),"yyyy-MM-dd") + "&priority=" + priorityCode.value(),
