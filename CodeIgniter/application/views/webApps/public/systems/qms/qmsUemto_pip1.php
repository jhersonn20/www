           ...
           change: function(e){
			    ...
			    for (var i = 0; i < selectedRows.length; i++) {
				    ...
				    var rowIndex = $("tr", this.tbody).index(selectedRows[i]),
						...
						checkedIds_enggMTO[twjrr_engg2_di.PROGRESS_RECID] = !this.tbody.find(">tr:not(.k-grouping-row)").eq(rowIndex).find("td").eq(11).find("input").is(":checked");
						if (!this.tbody.find(">tr:not(.k-grouping-row)").eq(rowIndex).find("td").eq(11).find("input").is(":checked") == false)
							$("#win2_Chk1").prop("checked",false);
		           		this.tbody.find(">tr:not(.k-grouping-row)").eq(rowIndex).find("td").eq(11).find("input").prop("checked", !this.tbody.find(">tr:not(.k-grouping-row)").eq(rowIndex).find("td").eq(11).find("input").is(":checked"));
