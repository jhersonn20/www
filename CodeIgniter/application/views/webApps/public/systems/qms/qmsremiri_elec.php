...
<div id="main-wrapper" style="min-height: 1000px">
	<div class="wrap-button demo-section" style="width: 516px;min-height: 505px;">
		    		...
		    		switch(this.id){
		    			case "printButt":
									...
									$("#window").data("kendoWindow").refresh({
									    url: "http://" + $(location).attr('hostname') + ":8080/JavaBridge/executeReport.php?xmlFile=qms/Electrical Item Request Issuance Report" + "&cArea=" + getArea + "&dtFrom=" + startDate + "&dtTo=" + endDate + "&iOption=" + $('input[name=option]:checked').index('input[name=option]'),
