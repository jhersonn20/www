		    		...
		    		switch(this.id){
		    			case "printButt":
							...
							$("#window").data("kendoWindow").refresh({
							    url: "http://" + $(location).attr('hostname') + ":8080/JavaBridge/executeReport.php?xmlFile=qms/Instrumentation Item Material Receiving" + "&asofdt=" + startDate + "&cArea=" + getArea + "&iOption=" + $('input[name=option]:checked').index('input[name=option]'),
