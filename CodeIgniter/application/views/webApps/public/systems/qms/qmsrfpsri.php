		    		...
		    		switch(this.id){
		    			case "printButt":
							...
							$("#window").data("kendoWindow").refresh({
							    url: "http://" + $(location).attr('hostname') + ":8080/JavaBridge/executeReport.php?xmlFile=qms/Fabricated Pipe Support Requested Issued" + "&drawNo=" + drawingNo.value() + "&fiDtFrom=" + kendo.toString(start.value(),"yyyy-MM-dd") + "&fiDtTo=" + kendo.toString(end.value(),"yyyy-MM-dd")  + "&iOption=" + $('input[name=option]:checked').index('input[name=option]')  + "&testPack=" + testPacker.value(),
