...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        var grid = $("#rowSelection").kendoGrid({
            ...
            columns: [
		       {field: "fwbs",width: 85,title: "FWBS"},
		       ...
		       {field: "item_code",width: 93,title: "Item Code"},
		       {field: "commodity_code",width: 133,title: "Commodity Code"},          
		       {field: "spool_category",width: 125,title: "Spool Category"},          
		       {field: "spool_no",width: 90,title: "Spool No."},               
		       {field: "spool_no1",width: 99,title: "Spool No. 1"},             
		       {field: "size",width: 95,title: "Size"},                    
		       {field: "group_size",width: 95,title: "Group Size"},              
		       {field: "qty",width: 85,title: "Qty"},                     
		       {field: "item_no",width: 115,title: "Item No."},                
		       {field: "fitting_length",width: 114,title: "Fitting Lenght"},          
		       {field: "total_length",width: 106,title: "Total Lenght"},            
		       {field: "bolt_length",width: 98,title: "Bolt Lenght"},             
		       {field: "group_1",width: 85,title: "Group 1"},                 
		       {field: "group_2",width: 85,title: "Group 2"},                 
		       {field: "mat_description",width: 149,title: "Material Description"},    
		       {field: "schedule_1",width: 95,title: "Schedule 1"},
		       {field: "schedule_2",width: 95,title: "Schedule 2"},              
		       {field: "painting_specs",width: 123,title: "Painting Specs."},         
		       {field: "insul_type",width: 120,title: "Insulation Type"},         
		       {field: "insul_thk",width: 120,title: "Insulation Thk."},         
		       {field: "insul_pipe_size",width: 152,title: "Insulation Pipe Size"},    
		       {field: "insul_lm_untraced",width: 174,title: "Insulation LM Untraced"},  
		       {field: "insul_lm_traced",width: 157,title: "Insulation LM Traced"},    
		       ...
		       {field: "painting_primer_s",width: 136,title: "Painting Primer S."},      
		       {field: "painting_top_coat_s",width: 154,title: "Painting Top Coat S."},    
		       {field: "piping_class",width: 102,title: "Piping Class"},            
		       {field: "field_desc",width: 130,title: "Field Description"},       
		       {field: "mat_location",width: 133,title: "Material Location"},       
