...
<div id="main-wrapper">
	<div class="wrap-button demo-section" style="width: 39.5%;min-height: 200px;position: fixed;top: 120px;left: 400px;">
		...
		<div>
		<label class="title" for="sel1" >Category:</label><select name="sel1" id="sel1" style="width: 300px" ></select>
		</div>
		<div><br /></div>
		<div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			var category = $("#sel1").kendoMultiSelect({
            filter: "contains",
            ...
            dataSource: {
                transport: {
                    read: {
                        url: crudService + "directCall/dd_category",
                    	type: "GET"
				    }
                },
		    			...
		    			case "printButt":
		    				if (confirm("Do you really want to print this item?")){	    					
								...
								$("#window").data("kendoWindow").refresh({
								    url: "http://" + $(location).attr('hostname') + ":8080/JavaBridge/executeReport.php?xmlFile=qms/Material Stock Summary" + "&asofdt=" + kendo.toString(start.value(),"yyyy-MM-dd") + "&adCat=" + category.value(),
