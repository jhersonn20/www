...
<div id="main-wrapper">
	<div class="wrap-button demo-section" style="width: 39.5%;min-height: 200px;position: fixed;top: 120px;left: 400px;">
		...
		<div>
		<label class="title" for="sel1" >Area No:</label><select name="sel1" id="sel1" style="width: 300px" ></select>
		</div>
		<div><br /></div>
		<div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			var cAreaNO = $("#sel1").kendoMultiSelect({
            filter: "contains",
		    		...
		    		switch(this.id){
	    				...
	    				if (confirm("Do you really want to print this item?")){	    					
							...
							$("#window").data("kendoWindow").refresh({
							    url: "http://" + $(location).attr('hostname') + ":8080/JavaBridge/executeReport.php?xmlFile=qms/Material Summary per Plant Area&asofdt=" + kendo.toString(start.value(),"yyyy-MM-dd") + "&edAreaNO=" + cAreaNO.value(),
