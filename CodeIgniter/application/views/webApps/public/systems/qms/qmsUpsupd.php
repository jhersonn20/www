	...
	$(document).ready(function(){
        ...
        var grid = $("#rowSelection").kendoGrid({
            ...
            columns: [    
		       ...
		       {field: "material_hdr",width: 128,title: "Material Header"},            
		       {field: "rev_no",width: 85,title: "Rev No."},                     
		       {field: "line_no",width: 85,title: "Line No."},                     
		       {field: "pipe_code",width: 92,title: "Pipe Code"},                     
		       {field: "support_code",width: 113,title: "Support Code"},                         
		       {field: "size",width: 54,title: "Size"},             
		       {field: "lb_sb",width: 65,title: "LB/SB"},           
		       {field: "qty_iso",width: 85,title: "Qty ISO"},           
		       {field: "item_no_code",width: 101,title: "Item# Code"},              
		       {field: "mat_description",width: 150,title: "Material Description"},              
		       {field: "type_figure",width: 98,title: "Type/Figure"},              
		       {field: "item",width: 54,title: "Item"},              
		       {field: "material_specs",width: 119,title: "Material Specs."},              
		       {field: "mategiral_categ",width: 140,title: "Material Category"},              
		       {field: "material_profile",width: 117,title: "Material Profile"},              
		       {field: "diameter",width: 85,title: "Diameter"},
		       {field: "schedule",width: 95,title: "Schedule"},
		       {field: "total_qty",width: 95,title: "Total Qty"},
		       {field: "um",width: 47,title: "UM"},
		       {field: "total_wt",width: 95,title: "Total Wt."},           
				...
				switch(this.id){
					...
					default:
						...
						$.each(dataSource.data(),function(index,value){
							...
							row['logupdate'] = "Upload Pipe Support Data";
							...
							$.post(crudService + "manage/psMto",postInfo,
								function(data){
									if ((ds_total - 1) == index)
