...
<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        var isoDwg_ds = new kendo.data.DataSource({
            transport: {
                read: {
                    url: crudService + "directCall/thwseRef_iso",
            ...
            schema: {
                ...
                model: {
                    ...
                    fields: {
                        ...
                        ref_no: { type: "string" },
                        ref_date: { type: "ref_date" },
                        client_ref_no: { type: "string" },
                        client_ref_date: { type: "string" },
                        tot_spl: { type: "float" },
                        tot_dia: { type: "float" }
                    }
                },
        ...
        var grid1 = $("#isoDwg_grid").kendoGrid({
            ...
            columns: [
               ...
               {field: "bore_type",title: "LB/SB",width: 100},
               {field: "matl_type",title: "EM/FAB",width: 100},
               {field: "priority",title: "Priority", width: 120},
               {field: "ref_no",title: "ARCC Ref No.", width: 120},
               {field: "ref_date",title: "ARCC Ref Date", width: 120},
               {field: "client_ref_no",title: "Client Ref No.", width: 150},
               {field: "client_ref_date",title: "Client Ref Date", width: 120},
               {field: "tot_spl",title: "Total Spool", width: 120},
               {field: "tot_dia",title: "Total Diainch", width: 120}
           ],
           change: function(e){
           		currRow = this;
	    			...
	    			case "exportButt":
	    				...
	    				var conF = confirm('Do you want to export files?');
	    					if(!conF){
					        	...
					        	link.href = crudService + "directCall/export_whse_query_iso/?";
