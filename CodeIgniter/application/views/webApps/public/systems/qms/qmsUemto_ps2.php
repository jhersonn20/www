	...
	<div class="wrap-form demo-section apply8" style="height: auto;">
		<fieldset>
			<ul style="width: 100%;">
				...
				<li>
					<label class="title" for="win2_txt5" style="width: 120px;">PS Code:</label><input type="text" name="win2_txt5" id="win2_txt5" class="k-textbox" required style="width: 148px;" />
				</li>
				<li>
					<label class="title" for="win2_txt6" style="width: 120px;">PS Type:</label><input type="text" name="win2_txt6" id="win2_txt6" class="k-textbox" required style="width: 148px;" />
				</li>
				<li>
					<label class="title" for="win2_txt7" style="width: 120px;">PS Class:</label><input type="text" name="win2_txt7" id="win2_txt7" class="k-textbox" required style="width: 148px;" />
				</li>
				<li>
					<label class="title" for="win2_txt8" style="width: 120px;">Line Size:</label><input type="text" name="win2_txt8" id="win2_txt8" class="k-textbox" required style="width: 148px;" />
				</li>
				<li>
					<label class="title" for="win2_txt9" style="width: 120px;">UOM:</label><input type="text" name="win2_txt9" id="win2_txt9" class="k-textbox" style="width: 148px;" />
				</li>
				<li>
