<div id="main-wrapper">
	...
	<div class="wrap-form demo-section apply8" style="width: 100%;display: block; margin-bottom: 20px; min-height: 650px;">
	...
	<div class="wrap-button demo-section" style="width: 100%;">
		<div class="buttonLeft" style="width: 40%">
        	...
        	<label class="title" for="txt4" style="width: 98px;">Total Diainch:</label><input type="text" name="txt4" id="txt4" class="k-textbox" style="width: 10%;" />
       	</div>
		<div class="buttonRight">
			Spool DiaInch</label><input type="text" name="txt5" id="txt5" class="k-textbox" style="width: 10%;" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        var isoDwg_ds = new kendo.data.DataSource({
            transport: {
                read: {
                    url: crudService + "directCall/isoTTiso",
