	...
	$(document).ready(function(){
            ...
            schema: {
               ...
               model: {
                    ...
                    fields: {
				        ...
				        plantno: {type: "string", editable: false},
				        ...
				        equipno: {type: "string", editable: false},        
				        equipdesc: {type: "string", editable: false},
				        totweight: {type: "string", editable: false},
				        docno: {type: "string", editable: false},
				        suppcode: {type: "string", editable: false},                    
				        remarks1: {type: "string", editable: false},               
				        jetnos: {type: "string", editable: false},        
				        loc: {type: "string", editable: false},        
				        receiveddt: {type: "string", editable: false},
				        remarks2: {type: "string", editable: false}
                    }
               },
        ...
        var ubrpip_rs = $("#rowSelection").kendoGrid({
            ...
            columns: [
		       ...
		       {field: "plantno",width: 150,title: "Plant No."},
		       {field: "drawno",width: 150,title: "Drawing No."},
		       {field: "sheetno",width: 150,title: "Sheet No."},                    
		       {field: "revno",width: 150,title: "Rev No."},               
		       {field: "priorno",width: 150,title: "Priorirty No"},        
		       {field: "equipno",width: 170,title: "Equip No"},        
		       {field: "equipdesc",width: 170,title: "Equip Desc"},
		       {field: "totweight",width: 150,title: "Total Weight"},
		       {field: "docno",width: 150,title: "Document No"},
		       {field: "suppcode",width: 150,title: "Supplier Code"},                    
		       {field: "remarks1",width: 150,title: "ISO Remarks"},               
		       {field: "jetnos",width: 150,title: "Jet Nos."},        
		       {field: "loc",width: 170,title: "Location"},        
		       {field: "receiveddt",width: 170,title: "Date Received"},
		       {field: "remarks2",width: 150,title: "Equipment Remarks"}
           ],
           change: function(e){
           		currRow = this;
			...
			click: function(){
				switch(this.id){
					...
					default:
						...
						open_preloader();
						$.post(crudService + "directCall/call_upl_isoEquip",{loguser: $("#hidden_user").val(), fileNames: fileName},
							function(data){
