...
<div id="main-wrapper" style="min-height: 700px">
	<div class="wrap-button demo-section" style="width: 40%;min-height:350px;position: absolute;top: 120px;left: 400px;">
		<fieldset style="width: 500px;">
		<div><br /></div>
		<div>
			<label class="title" for="sel2">Area Loc:</label><select name="sel2" id="sel2" style="width: 300px;"></select>
		</div>
		<div><br /></div>
		<fieldset>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var areaDesc = $("#sel2").kendoMultiSelect({
            filter: "contains",
		    			...
		    			case "printButt":
		    				if (confirm("Do you really want to print this item?")){	    					
								...
								$("#window").data("kendoWindow").refresh({
								    url: "http://" + $(location).attr('hostname') + ":8080/JavaBridge/executeReport.php?xmlFile=qms/Material Per Area Location Register" + "&carea_loc=" + areaDesc.value() + "&ioption=" + $('input[name=option]:checked').index('input[name=option]'),
