			...
			<div class="wrap-form demo-section apply8" style="width: 27.9%;float:right;height: auto;display: block;">
				<fieldset>
					...
					<ul class="formLeft_qms" style="width: 100%;">
						...
						<li>
							<label class="title" for="textarea2" style="width: 100px;">Remarks:</label><textarea name="textarea2" id="textarea2" cols="20" rows="3" style="resize: none;width: 142px;margin: 0;"></textarea>
						</li>
	...
	<div class="jwrrdtl_phase" style="margin-top: 5px;">
		...
		<div class="wrap-button demo-section">
			<div class="buttonLeft">
	        	...
	        	<button class="k-button mainEve" id="jmifButt">JMIF</button>
	       	</div>
			<div class="buttonRight">
	    ...
	    for (var i = 0; i < selectedRows.length; i++) {
	      ...
	      if (grid == "#rowSelection"){
	        ...
	        if (dataItem3.finalized == 0 || dataItem3.finalized == null){	        	
	        	...
	        	$("#editButt, #delButt, #addButt2, #editButt2, #delButt2, #jmifButt").prop("disabled", true).addClass("k-state-disabled");
		    ...
		    $("#textarea2").val(dataItem3.remarks);
	...
	$(document).ready(function(){
        ...
        var grid = $("#rowSelection").kendoGrid({
            ...
            columns: [
               ...
               {field: "remarks",title: "Remarks", width: 110}
           ],
           change: function(e){
           		currRow = this;
	    		...
	    		switch(this.id){
	    			...
	    			default:
	    				if (this.id.indexOf("2") < 0){
							...
							jwrr_date.enable(true);
							rcvd_date.enable(true);
							qcmrir_date.enable(true);
							rfi_date.enable(true);
