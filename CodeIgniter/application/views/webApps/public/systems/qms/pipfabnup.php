	...
	$(document).ready(function(){
        ...
        var grid = $("#uploadBrowse").kendoGrid({
            ...
            columns: [
				...
				{field: "job_no",width: 92,title: "Job No"},      
				{field: "mat_tag",width: 92,title: "Mat Tag"},
	            {field: "issued_date",width: 92,title: "Deliv. To Paint"},
	            {field: "deliv_to_fab",width: 119,title: "Paint Date"},              
				{field: "fab_dt",width: 114,title: "QC. Release Paint"},       
				{field: "fab_released",width: 142,title: "Deliv. @ Site"},
				{field: "err_remarks",title: "Error Remarks"}
           ],
           change: function(e){
           		currRow = this;
			...
			click: function(){
				switch(this.id){
					...
					default:
						...
						$.post(crudService + "directCall/psFabMto",{rows: $("#objStr").val()},
							function(data){
