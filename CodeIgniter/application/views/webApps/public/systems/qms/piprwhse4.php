...
<div id="main-wrapper">
	<div class="wrap-button demo-section" style="width: 39.5%;min-height: 530px;position: fixed;top: 120px;left: 400px;">
		...
		<div><br /></div>
		<div>
			<label class="title" for="sel1" style="width: 100px;">ALL</label><input type="radio" name="option" value="ALL" checked id="rad1" />
        	<label class="title" for="sel1" style="width: 100px;">LB</label><input type="radio" name="option" value="LB" id="rad2" />
        	<label class="title" for="sel1" style="width: 100px;">SB</label><input type="radio" name="option" value="SB" id="rad3" />
		</div>
		<div><br /></div>
		<div>
