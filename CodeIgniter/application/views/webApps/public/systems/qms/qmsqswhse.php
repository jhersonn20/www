			...
			<ul>
				<li>
					<label class="title" for="txt1" style="width: 60px;margin-left: 0;">Area No:</label><input type="text" name="txt1" id="txt1" class="k-textbox k-state-disabled" disabled style="width: 100px;margin-right: 0px;" />
	       			<label class="title" for="txt2" style="width: 30px;margin-left: 0;">ISO:</label><input type="text" name="txt2" id="txt2" class="k-textbox k-state-disabled" disabled style="width: 353px;margin-right: 0px;" />
	       			...
	       			<label class="title" for="txt4" style="width: 80px;margin-left: 0;">Piece No:</label><input type="text" name="txt4" id="txt4" class="k-textbox k-state-disabled" disabled style="width: 130px;margin-right: 0px;" />
	       		</li>
				<li>
...
<script type="text/javascript">
	...
	function grid_change(e,grid){
		...
		for (var i = 0; i < selectedRows.length; i++) {
			...
			$("#txt3").val(dataItem.piece_no);
			$("#txt4").val(dataItem.piece_no);
			$("#txt7").val(dataItem.piece_desc);
	...
	$(document).ready(function(){
        ...
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: crudService + "directCall/pipTwhseStr",
        ...
        var grid = $("#rowSelection").kendoGrid({
            ...
            columns: [
               ...
               {field: "um",title: "Unit of Measure",width: 140},
               {field: "piece_no",title: "Piece No",width: 120},
               {field: "qty",title: "Quantity",width: 120},
               {field: "piece_desc",title: "Description",width: 120},
	    	...
	    	click: function(e){
	    		switch(this.id){
	    			case "exportButt":
				        ...
				        link.href = crudService + "directCall/export_pipTwhseStr/?";
