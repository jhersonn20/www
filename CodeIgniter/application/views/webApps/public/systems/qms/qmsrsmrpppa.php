...
<div id="main-wrapper">
	<div class="wrap-button demo-section" style="width: 39.5%;min-height: 490px;position: fixed;top: 120px;left: 400px;">
		...
		<div><br /></div>
		<div>
		<label class="title" for="sel1" >Plant No:</label><select name="sel1" id="sel1" style="width: 300px" ></select>
		</div>
		<div><br /></div>
		<div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			var plantNo = $("#sel1").kendoMultiSelect({
            filter: "contains",
            ...
            dataSource: {
                transport: {
                    read: {
                        url: crudService + "directCall/dd_plant_no",
                    	type: "GET"
				    }
                },
        ...
        var areaNo = $("#sel2").kendoMultiSelect({
            ...
            dataSource: {
                transport: {
                    read: {
                        url: crudService + "directCall/dd_pieceStruct_areaNo",
                    	type: "GET"
				    }
                },
                //serverFiltering: true,
		    		...
		    		switch(this.id){
		    			case "printButt":
							...
							$("#window").data("kendoWindow").refresh({
							    url: "http://" + $(location).attr('hostname') + ":8080/JavaBridge/executeReport.php?xmlFile=qms/Structural Material Register Per Plant Area" + "&cAreas=" + areaNo.value() + "&cPlants=" + plantNo.value() + "&fiAsofDt=" + kendo.toString(start.value(),"yyyy-MM-dd") + "&iOption=" + $('input[name=option]:checked').index('input[name=option]'),
