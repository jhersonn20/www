...
<div id="main-wrapper">
	<div class="wrap-button demo-section" style="width: 39.5%;min-height: 270px;position: fixed;top: 120px;left: 400px;">
		...
		<div><br /></div>
		<div>
		<label class="title" for="txt3" style="width: 0px;">Date:</label>
		</div>
		<div><br /></div>
		<div>
			<input type="text" name="txt3" id="txt3" style="width: 33%;"/> 
		</div >
		<div class="buttonRight">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
            ...
            dataSource: {
                transport: {
                    read: {
                        url: crudService + "directCall/dd_subPriorityCode",
                    	type: "GET"
				    }
                },
		    		...
		    		switch(this.id){
	    				...
	    				if (confirm("Do you really want to print this item?")){	    					
							...
							$("#window").data("kendoWindow").refresh({
							    url: "http://" + $(location).attr('hostname') + ":8080/JavaBridge/executeReport.php?xmlFile=qms/PIPE SUPPORT SUMMARY PER PRIORITY AREA LOCATION" + "&cut_off_sched=" + kendo.toString(start.value(),"yyyy-MM-dd") + "&priority=" + priorityCode.value() + "&fisubby=" + $("#txt3").val(),
