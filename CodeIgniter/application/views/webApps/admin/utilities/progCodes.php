	...
	jQuery(document).ready(function(){
		...
		jQuery("#grid").jqGrid('navGrid','#pager',
			{}, //options
			{
				...
				modal: true,
				processData: 'Updating the Programmer Code\'s list...',
				editCaption: 'Edit a Programmer Code',
				closeAfterEdit: true,
				checkOnUpdate: true,
			...
			},
			{
				...
				reloadAfterSubmit: true,
				modal: true,
				processData: 'Inserting the Programmer Code...',
				editCaption: 'Add a Programmer Code',
				closeAfterAdd: true,
				checkOnUpdate: true,
				beforeCheckValues: function(postdata, formid, mode) {
		            var cm = grid[0].p.colModel[getColumnIndexByName('group_code')];
