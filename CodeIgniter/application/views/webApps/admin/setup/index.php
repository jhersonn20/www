<div class="setupBox mainContent">
    <span class="title"> Setup Maintenance </span>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		...
		var dataSource = new kendo.data.DataSource({
			transport: {
				read: {
					url: "/codeIgniter/index.php/webapps/ln_setup/directCall",
                    contentType: "application/json"
				},
	            create: {
	                url: "/codeIgniter/index.php/webapps/ln_setup/manage",
	                type: "POST"
	            },
	            update: {
	                url: "/codeIgniter/index.php/webapps/ln_setup/manage",
	            ...
	            destroy: {
	                url: "/codeIgniter/index.php/webapps/ln_setup/remove",
	                type: "POST"
	            }
			},
	        error: function(e) {
