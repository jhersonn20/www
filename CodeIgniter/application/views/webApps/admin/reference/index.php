<div class="refBox mainContent">
    <span class="title"> Reference Maintenance </span>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		...
		var dataSource = new kendo.data.DataSource({
			transport: {
				read: {
					url: "/codeIgniter/index.php/webapps/ln_reference/directCall",
                    contentType: "application/json"
				},
	            create: {
	                url: "/codeIgniter/index.php/webapps/ln_reference/manage",
	                type: "POST"
	            },
	            update: {
	                url: "/codeIgniter/index.php/webapps/ln_reference/manage",
	            ...
	            destroy: {
	                url: "/codeIgniter/index.php/webapps/ln_reference/remove",
	                type: "POST"
	            }
			},
	        error: function(e) {
