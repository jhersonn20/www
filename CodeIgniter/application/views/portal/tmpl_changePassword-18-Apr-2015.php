<!--<script type="text/x-kendo-template" id="changePassword">-->
	...
	<script type="text/javascript">
		$(document).ready(function(){
		    ...
		    var log_user = '<?php echo $_POST['log_user']; ?>';
			...
			$("#applyButt").click(function(){
				...
				$.post("https://" + $(location).attr("hostname") + "/index/manage/user",{user_id: $("#user").val(), currPass: $("#currPass").val(), password: $("#newPass").val(), id: <?php echo $_POST['id']; ?>, log_user: log_user},
				function(data){
					if (data != 1){
