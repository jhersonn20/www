...
<script type="text/javascript">
	$(document).ready(function(){ 
		var crudService = '/codeigniter/index.php/portal/' + "index/",
		    filterFArr_user = [], filterOArr_user = [], filterVArr_user = [], user_di = "", log_user = '<?php echo $_POST['log_user']; ?>', dept = '<?php echo $_POST['dept']; ?>';
	    ...
	    var dept_CB = function(container, options) {
	        $('<input ' + (options.model.client_short == "ARCC" ? 'required' : '') + ' data-text-field="dept_name" data-value-field="dept_code" id="department" data-bind="value:' + options.field + '"/>')
	            .appendTo(container)
	            .kendoComboBox({
				    ...
				    enable: (options.model.client_short == "ARCC"),
				    dataSource: {
			                transport: {
			                    read: crudService + "directCall/dept_dd",
        ...
        var user_rs = $("#user_rs").kendoGrid({
            ...
            columns: [
               ...
               {field: "department",title: "Department",width: 119, editor: dept_CB},
               {
               	field: "user_id",
               	title: "User ID",
                width: 110
