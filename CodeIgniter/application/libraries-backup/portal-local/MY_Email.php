<?php
	...
	class MY_Email extends CI_Email {
		private $msgHeader = "You may now log-in to the <a href='http://localhost/codeIgniter/index.php/portal/' style='text-decoration: none;color: #0f73a9;'> ARCC Portal </a> using the information below:";
