<?php
	class CI_Email  {
		...
		protected $msgFooter = "Please do not reply to this mail as it is automated and cannot be responded to. This email was sent by: Management Group of Al Rushaid Construction Company, Limited. <br /> If you're not expecting any files from ARCC, kindly ignore this email.";
		protected $msgFooter2 = "Please do not reply to this mail as it is automated and cannot be responded to. This email was sent by: Management Group of Al Rushaid Construction Company, Limited.";
		protected $conn = "";
		protected $td_style = "";
		protected $th_style = "";
