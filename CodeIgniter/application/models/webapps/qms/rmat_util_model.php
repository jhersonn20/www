<?php
    class rmat_util_Model extends CI_Model {
    	private $tblName = "rmat_util";
        ...
        public function set(){
            ...
            if ($_POST['PROGRESS_RECID'] == "0"){
            	$query = $this->is_entry_unique(array('util_code' => $_POST['util_code']));
            	if (gettype($query) == 'boolean'){
            		if (!$query){
	            		$query = "Failed! Duplicate 'util_code' found for '{$_POST['util_code']}' item!";
	            		return $query;
	            	}
            	}else
            		return $query;
