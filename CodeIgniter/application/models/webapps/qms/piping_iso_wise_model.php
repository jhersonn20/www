<?php
    class Piping_Iso_Wise_Model extends CI_Model {
    	private $tblName = "tt_export_whseISOwise";
		...
		public function proc_export($cArealoc){
			...
			$sql .= "exec @result = tempdb_sql.dbo.proc_export_whseISOwise @cArealoc = '{$cArealoc}';";
