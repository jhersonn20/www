<?php
    class Twhse_pip_mat_model extends CI_Model {
    	private $tblName = "twhse_pip_mat";
        ...
        public function export_modified(){
        	$sql = "SELECT area_no,drawing_no,sheet_no,rev_no,item_code,size,uom,spool_no,spl_type,category,item_no,qty,mat_desc,client_refno,client_refdate,rcvd_date,rfi_no,rfi_date,qcmrir_no,qcmrir_date,iss_qty,issued_date,jmif_no,rcvd_by,direct_with,dlmr_jwrr,excess FROM {$this->tblName}";
			$rowArr = $this->piping->query($sql)->result_array();
