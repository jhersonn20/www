 ...
 *
 *
 * Modifications by Julian Magnone
 * - charset support
 * - simple error handler
 * - Windows Authentication Mode only (now supported when connect)
 *
 * @package		CodeIgniter
 * @subpackage	Drivers
 * @category	Database
 * @author		Julian Magnone <jmagnone@mgnn.com>
 * @link		http://www.mgnn.com
 *
 */
