...
class CI_Email {
	...
	var	$smtp_host		= "172.16.2.4";		// SMTP Server.  Example: mail.earthlink.net smtp.arcc-eei.com
	var	$smtp_user		= "portal@hq.arcc.com";		// SMTP Username arg\system.arcc 
	var	$smtp_pass		= "1234Portal";		// SMTP Password Inf0t3ch  
	var	$smtp_port		= "25";		// SMTP Port 587
