...
(function($){
	...
	$.jMenu = {
		...
		init:function(options){
			...
			$("#jMenu span:not(.fNiv)").each(function(){
				var $thisChild = $(this);
		...
		****************************/
		...
		_returnUlWidth:function(el) {
			//alert(opts.ulWidth + ", " + parseInt(el.parent().outerWidth()) + ", " + parseInt(opts.ulWidth));
			switch(opts.ulWidth) {
				case "auto" :
		...
		_isReadable:function(){
			if($("a.fNiv").length > 0 || $("span.fNiv").length > 0)	return true;
			else return false;
		},
