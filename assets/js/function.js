...
function check_browser(){
		...
		// }else if ($.browser.msie && browserVersion[0] >= 9){
			...
			// showNotif('Warning','<ul id="pUL"><li><img src="/assets/images/browser/chrome.png" /><span>Google Chrome 20.0++</span></li><li><img src="/assets/images/browser/firefox.png" /> Firefox 11.0++</li></ul>','warning');
			var notifTitle = ""
				notifText = "",
				notifType = "";
			...
			// //}else {
				...
				notifText = '<ul id="pUL"><li><img src="/assets/images/browser/chrome.png" /><span>Google Chrome 20.0+</span></li><li><img src="/assets/images/browser/firefox.png" /> Firefox 11.0+</li></ul>'; //<li><img src="/assets/images/browser/ie.png" /> Internet Explorer 9.0 </li></ul>';
				notifType = 'info';
			// //}
			$.pnotify({
				title: notifTitle,
